...
class _VoucherListScreenState extends State<VoucherListScreen> {
  ...
  @override
  void dispose() {
    for (final c in [_searchCtrl, _horizontalHeaderCtrl, _horizontalBodyCtrl, _horizontalFooterCtrl]) {
      c.dispose();
    }
                      ...
                      children: [
                        SingleChildScrollView(
                          ...
                          child: Container(
                            width: dynamicWidth,
                            height: 40,
                            decoration: const BoxDecoration(color: AppColors.cardBg, border: Border(bottom: BorderSide(color: AppColors.border, width: 1.2))),
                            child: Row(
                              children: [

class GstConstants {
  static final RegExp gstinRegex = RegExp(
  ...
  static List<String> get allSortedStateNames =>
      stateCodes.values.toSet().toList()..sort();

  static String getStateName(String code) => stateCodes[code] ?? 'Unknown';

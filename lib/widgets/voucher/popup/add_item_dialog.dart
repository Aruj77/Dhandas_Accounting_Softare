...
class _AddItemDialogState extends State<AddItemDialog> {
  ...
  void initState() {
    ...
    if (widget.isEdit && widget.initialItem != null) {
      ...
      _salesPriceController.text = item.salesPrice > 0
          ? item.salesPrice.toStringAsFixed(2)
          : '';

      _purchasePriceController.text = item.purchasePrice > 0
      ...
      _selectedTaxCategory = _taxCategories.isNotEmpty
    ...
    await LoadingService.wrap(() async {
      ...
      setState(() {
        ...
        if (raw['taxCategories'] is List &&
          ...
          _taxCategories = (raw['taxCategories'] as List)
              .map((e) => e.toString())
              .toList();
        }
  ...
  Widget _buildHeader() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(color: AppColors.border.withOpacity(.55)),
        ),
      ),
      child: Row(
        children: [
  ...
  Widget _buildSectionCard({
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.border.withOpacity(.72)),
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
                    ...
                    return _buildAutocompleteTextField(
                      ...
                      validator: (val) {
                        ...
                        final match = _units.any(
                          (u) => u.toUpperCase() == val.trim().toUpperCase(),
                        );
                    ...
                    return _buildAutocompleteTextField(
                      ...
                      validator: (val) {
                        ...
                        final match = _taxCategories.any(
                          (c) => c.toUpperCase() == val.trim().toUpperCase(),
                        );
      ...
      child: Material(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: AppColors.border.withOpacity(.9)),
            boxShadow: [
              BoxShadow(
              ...
              itemBuilder: (context, index) {
                ...
                return Material(
                  ...
                  child: InkWell(
                    ...
                    hoverColor: AppColors.primaryLight.withOpacity(.55),
                    child: Padding(
  ...
  OutlineInputBorder _inputBorder({Color? color, double width = .9}) {
    return OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(
        color: color ?? AppColors.border.withOpacity(.85),
        width: width,
      ),
    );
  }
  ...
  Widget _buildFooter() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppColors.surface,
        border: Border(
          top: BorderSide(color: AppColors.border.withOpacity(.65)),
        ),
      ),
      child: Row(
        children: [
          ...
          OutlinedButton(
            ...
            style: OutlinedButton.styleFrom(
              ...
              side: BorderSide(color: AppColors.border.withOpacity(.9)),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(11),
              ),
            ),

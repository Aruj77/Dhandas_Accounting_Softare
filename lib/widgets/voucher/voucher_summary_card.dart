...
class VoucherSummaryCard extends StatelessWidget {
  ...
  final ValueListenable<VoucherTotalsResult>? totalsNotifier;
    ...
    return RepaintBoundary(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
              color: AppColors.dialogShadowLight,
              blurRadius: 8,
              offset: Offset(0, 2),
            ),
          ],
        ),
        child: totalsNotifier != null
            ? ValueListenableBuilder<VoucherTotalsResult>(
                valueListenable: totalsNotifier!,
                builder: (context, totals, _) => _buildContent(
  ...
  Widget _buildContent({
    ...
    return Column(
      ...
      children: [
        ...
        _buildSummaryRow(
          'Sundries',
          '${sundryTotal >= 0 ? '+' : ''}₹${sundryTotal.toStringAsFixed(2)}',
        ),
        _buildSummaryRow(
          'Rounding',

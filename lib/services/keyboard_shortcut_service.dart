...
class KeyboardShortcutService {
  ...
  static final List<KeyboardShortcutDefinition> definitions = [
    ...
    KeyboardShortcutDefinition(
      ...
      description:
          'Open the selected action or confirm the highlighted target.',
      options: _navigationOptions,
    ),
    KeyboardShortcutDefinition(
      ...
      title: 'Go Back',
      description:
          'Close the current view, dialog, or go to the previous layer.',
      options: _navigationOptions,
    ),
    KeyboardShortcutDefinition(
  ...
  static bool matchesAction(
    ...
    return switch (actionId) {
      moveUpAction => eventKeyId == keyArrowUp || eventKeyId == keyNumpad8,
      moveDownAction => eventKeyId == keyArrowDown || eventKeyId == keyNumpad2,
      activateAction => eventKeyId == keyEnter || eventKeyId == keyNumpadEnter,
      _ => false,
    };
  }
}
